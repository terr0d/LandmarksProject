## Задания и пояснения по решению
  - [Задание 1](#задание-1)
  - [Задание 2](#задание-2)
  - [Задание 3](#задание-3)

## Поиск по изображению
![img2text](src/README_img2text_demo.jpg)
## Поиск по тексту
![text2img](src/README_text2img_demo.jpg)

## Установка и запуск
1. Клонируйте репозиторий:
```bash
git clone https://github.com/terr0d/LandmarksProject.git
cd LandmarksProject
```
...
```
3. Установите [Pytorch](https://pytorch.org/get-started/locally/) (с поддержкой CUDA или CPU-only)
...
```
> [!IMPORTANT]
> В репозитории **нет исходных изображений достопримечательностей**.
>
> При обычном запуске поиск по тексту будет возвращать **картинки-заглушки**, но с подписями реальных мест из `metadata.csv`.
>
> Если хотите увидеть реальные фото в демо:
>   1. Загрузите все файлы `*_images.csv` из исходного датасета в папку `data`.
>   2. Запустите скрипт из корневой папки:
>      ```bash
>      python create_img_folders.py
>      ```
>   3. Скрипт создаст папки с изображениями в необходимом формате и структуре.
---
### Задание 1
